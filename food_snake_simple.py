...
class Food(
    Turtle):  # superclass Turtle # inherit food class from turtle.it contains all things of turtle class but also some we add.
    def __init__(self):
    ...
    def refresh(self):
        random_x = random.randint(-280,
                                  280)  # it is of 300 l and w so to generate food in between take some less i.e-280t0280
        # same in y-axis generate food between random anywhere from -280 b/w 280 .
        random_y = random.randint(-280, 280)
        self.goto(random_x,
                  random_y)  # goto:-for moving  x,y loction we give but in this we move it to random x,position as we did above.
